...
- เข้าไปที่ `/admin-manage` ต้อง login ด้วยบัญชี Supabase Auth (อีเมล + รหัสผ่าน) ก่อนถึงจะเข้าใช้งานได้ — ทีมร้าน (โบ๊ท/วอลเล่/โบว์/น้าเหน่ง) ใช้บัญชีเดียวร่วมกัน
...
- แท็บ **สต็อกสินค้าพร้อมขาย / สินค้าขายแล้ว**: ดูรายการแยกตามสถานะ กรองตามเจ้าของทุนได้ (รวมปุ่ม **ไม่ระบุ** สำหรับหาสินค้าที่ลืมใส่เจ้าของทุน) กด **แก้ไข** เพื่อแก้ข้อมูล/รูป, **ขายแล้ว** เพื่อบันทึกข้อมูลการขาย, หรือ **ลบ** เพื่อลบสินค้าออกจากเว็บและลบไฟล์รูปทั้งหมดออกจาก Storage ทันที (ลบถาวร กู้คืนไม่ได้)
- แท็บ **รายงาน**: รวมรายงานย่อยหลายแบบ
  - **รายงานการขาย**: ยอดขาย/กำไร/ปันผล แยกตามเจ้าของทุน (โบ๊ท/วอลเล่/โบว์/น้าเหน่ง) ต่อเดือน พร้อมกราฟเทียบย้อนหลังและ export Excel
  - **รายงานปันผล**: สรุปยอดปันผลแยกตามคน (โบ๊ท/วอลเล่/โบว์/น้าเหน่ง/เมจิ) ย้อนหลังได้ 12 เดือน
  - **สต็อกคงเหลือตามเจ้าของทุน**, **สินค้าค้างสต็อกเกิน 15 วัน**, และตัวช่วยลบรูปสินค้าที่ขายแล้วเกิน 3 เดือน
