...
export type ProductOwner = 'โบ๊ท' | 'วอลเล่' | 'โบว์' | 'น้าเหน่ง' | 'โบ๊ทและวอลเล่'

export const OWNERS: ProductOwner[] = ['โบ๊ท', 'วอลเล่', 'โบว์', 'น้าเหน่ง', 'โบ๊ทและวอลเล่']
